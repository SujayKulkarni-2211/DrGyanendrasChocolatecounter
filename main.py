...
# Title label
title_label = tk.Label(root, text="Dr. Gyanendra's Chocolate Counter", font=("Arial", 22, "bold"))
title_label.grid(row=0, column=0, columnspan=3, pady=10)

# Load and display image of Gyanendra sir
image = Image.open("gyanendra_sir.jpeg")
...
# Slogan label
slogan_label = tk.Label(root, text="📚 Encouraging Learning Every Day 🍫", font=("Arial", 20), fg="orange")
slogan_label.grid(row=2, column=0, columnspan=3, padx=5, pady=5)
...
chocolates_label.grid(row=4, column=0, padx=5, pady=5)
chocolates_entry = tk.Entry(root)
chocolates_entry.grid(row=4, column=1, padx=5, pady=5)
